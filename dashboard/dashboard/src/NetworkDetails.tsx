...
import {
  networkDetailsEndPoint,
  dataSetsEndPoint,
  compileNetwrokEndPoint,
  trainNetwrokEndPoint,
  plotAccEndPoint,
  plotLossEndPoint,
} from "./Config";
  ...
  createDataSources = () => {
    ...
    if (this.getDataSources().length > 0) {
      this.getDataSources().forEach(function (value) {
        console.log(value);
        data_sources.push(<option value={value}>{value}</option>);
      });
    }
    return data_sources;
  };
          ...
          <div className="row">
            ...
            <div className="col-75">
              <select name="loss">
                ...
                <option value="kullback_leibler_divergence">
                  kullback_leibler_divergence
                </option>
                <option value="poisson">poisson</option>
                <option value="cosine_proximity">cosine_proximity</option>
                <option value="is_categorical_crossentropy">
          ...
          <div className="row">
            ...
            <div className="col-75">
              <select name="metrics">
                ...
                <option value="categorical_accuracy">
                  categorical_accuracy
                </option>
                <option value="sparse_categorical_accuracy">
                  sparse_categorical_accuracy
                </option>
                <option value="top_k_categorical_accuracy">
                  top_k_categorical_accuracy
                </option>
                <option value="sparse_top_k_categorical_accuracy">
      ...
      <div className="container">
        <form onSubmit={this.trainNetworkHandler}>
          ...
          <div className="row">
            ...
            <div className="col-75">
              <select name="data_set">{this.createDataSources()}</select>
            </div>
          </div>
          <div className="row">
            <div className="col-25">
          ...
          <div className="row">
            ...
            <div className="col-75">
              <input name="input_shape" type="number" />
            </div>
          </div>
          <div className="row">
            <div className="col-25">
            ...
            <div className="col-75">
              <input name="test_sample_size" type="text" />
            </div>
          </div>
    ...
    return (
      <div>
        ...
        <textarea
          ...
          rows={50}
          cols={50}
          value={JSON.stringify(this.getNetworkDetails())}
        ></textarea>
      </div>
    );
  }

...
class TrainNetworkPage:
    ...
    def set_epochs(self, epochs: str) -> TrainNetworkPage:
        ...
        self.web_driver_wrapper.driver.find_element(*TrainNetworkPage.epochs_input) \
            .send_keys(epochs)
        return self

    def set_batch_size(self, batch_size: str) -> TrainNetworkPage:
        self.logger.log().info(f"Set batch_size field: {batch_size}")
        self.web_driver_wrapper.driver.find_element(*TrainNetworkPage.batch_size_input) \
    ...
    def set_input_shape(self, input_shape: str) -> TrainNetworkPage:
        ...
        self.web_driver_wrapper.driver.find_element(*TrainNetworkPage.input_shape_input) \
    ...
    def set_test_sample_size(self, test_sample_size: str) -> TrainNetworkPage:
        ...
        self.web_driver_wrapper.driver.find_element(*TrainNetworkPage.test_sample_size_input) \
    ...
    def set_data_set(self, dat_set: str) -> TrainNetworkPage:
        ...
        Select(self.web_driver_wrapper.driver.find_element(*TrainNetworkPage.dat_set_select)) \
    ...
    def click_train_network_button(self) -> TrainNetworkPage:
        ...
        self.web_driver_wrapper.driver.find_element(*TrainNetworkPage.train_network_button) \
            .click()
        return self
    ...
    def check_if_network_is_trained(self, names: list):
        for name in names:
            ...
            label = self.web_driver_wrapper.driver.find_element(By.XPATH,
                                                                f'//*[@id="{name}"]/td/label[@id="trained"]').text
            assert label == "true"
